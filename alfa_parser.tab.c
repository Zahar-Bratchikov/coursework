...
{
  "\"end of file\"", "error", "\"invalid token\"", "VARIABLE", "SIN",
  "COS", "EXP", "LN", "PLUS", "MINUS", "MULT", "DIV", "POW", "EOL",
  "NUMBER", "'('", "')'", "$accept", "input", "line", "expression", "term",
  "factor", "exponent", YY_NULLPTR
};
...
{
      -8,     0,    -8,    -8,    -5,    10,    37,    39,    -8,    17,
      -8,    34,    38,    -4,    17,    17,    17,    17,    -7,    17,
      17,    -8,    17,    17,    17,    19,    21,    25,    30,    -8,
      38,    38,    -4,    -4,     4,    -8,    -8,    -8,    -8,    -8
};
...
{
       2,     0,     1,    12,     0,     0,     0,     0,    11,     0,
       3,     0,     5,     8,     0,     0,     0,     0,     0,     0,
       0,     4,     0,     0,     0,     0,     0,     0,     0,    18,
       6,     7,     9,    10,    19,    17,    13,    14,    15,    16
};
...
{
       2,    19,    20,     3,     4,     5,     6,     7,    24,    29,
      14,    18,    19,    20,     8,     9,    25,    26,    27,    28,
       3,     4,     5,     6,     7,    15,    34,    19,    20,    19,
      20,     8,     9,    19,    20,    36,     0,    37,    19,    20,
       0,    38,    19,    20,    32,    33,    39,    21,    22,    23,
      30,    31,    16,     0,    17
};

static const yytype_int8 yycheck[] =
{
       0,     8,     9,     3,     4,     5,     6,     7,    12,    16,
      15,     9,     8,     9,    14,    15,    14,    15,    16,    17,
       3,     4,     5,     6,     7,    15,    24,     8,     9,     8,
       9,    14,    15,     8,     9,    16,    -1,    16,     8,     9,
      -1,    16,     8,     9,    22,    23,    16,    13,    10,    11,
      19,    20,    15,    -1,    15
};
...
{
       0,    18,     0,     3,     4,     5,     6,     7,    14,    15,
      19,    20,    21,    22,    15,    15,    15,    15,    20,     8,
       9,    13,    10,    11,    12,    20,    20,    20,    20,    16,
      21,    21,    22,    22,    20,    23,    16,    16,    16,    16
};
